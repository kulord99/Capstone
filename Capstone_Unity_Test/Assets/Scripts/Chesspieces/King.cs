    ...
    public override SpecialMove GetSpecialMoves(ref ChessPiece[,] board, ref List<Vector2Int[]> moveList, ref List<Vector2Int> availableMoves)
    {
        ...
        if(kingMove == null && currentX ==4)
        {
            if(team == 0)
            {
                //Left Rook
                if (leftRook == null)
                    if (board[0, 0].type == ChessPieceType.Rook && board[0, 0].team == 0)
                ...
                //Right Rook
                if (rightRook == null)
                    if (board[7, 0].type == ChessPieceType.Rook && board[7, 0].team == 0)
            ...
            else
            {
                //Left Rook
                if (leftRook == null)
                    if (board[0, 7].type == ChessPieceType.Rook && board[0, 7].team == 1)
                ...
                //Right Rook
                if (rightRook == null)
                    if (board[7, 7].type == ChessPieceType.Rook && board[7, 7].team == 1)
